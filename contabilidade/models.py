...
class Equipe(Base):
    ...
    foto = StdImageField('Foto', upload_to='equipe',variations={'thumb': {'width': 480, 'height':480, 'crop':True}})
...
class Nota(Base):
    ...
    contaCredito = models.ForeignKey('contabilidade.Conta', related_name='Credito', verbose_name='Conta', on_delete=models.CASCADE, default=0)
    contaDebito = models.ForeignKey('contabilidade.Conta', related_name='Debito', verbose_name='Conta', on_delete=models.CASCADE, default=0)
